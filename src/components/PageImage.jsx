...
const HOTSPOTS = [
  ...
  { label: 'Читать новость о салате', target: 'blog-page', x: 350, y: 9600, width: 230, height: 82 },
  { label: 'Читать новость о витаминах', target: 'blog-page', x: 1070, y: 9600, width: 230, height: 82 },
