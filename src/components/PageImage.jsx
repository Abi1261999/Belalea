...
const HOTSPOTS = [
  ...
  { label: 'В каталог', target: 'shop-page', x: 260, y: 735, width: 216, height: 82 },
  { label: 'Новинка', target: 'shop-page', x: 258, y: 1258, width: 684, height: 274 },
  ...
  { label: 'Тыквенное масло', target: 'product-page', x: 260, y: 3180, width: 330, height: 640 },
  { label: 'Кунжутное масло', target: 'product-page', x: 620, y: 3180, width: 330, height: 640 },
  { label: 'Масло грецкого ореха', target: 'product-page', x: 980, y: 3180, width: 330, height: 640 },
  { label: 'Конопляное масло', target: 'product-page', x: 1340, y: 3180, width: 330, height: 640 },
  { label: 'Смотреть все продукты', target: 'shop-page', x: 830, y: 4290, width: 260, height: 82 },
  { label: 'Отзывы покупателей', target: 'reviews', x: 580, y: 4550, width: 760, height: 520 },
  { label: 'Смотреть все предложения', target: 'shop-page', x: 1400, y: 6090, width: 250, height: 84 },
  { label: 'Предложение месяца 1', target: 'product-page', x: 260, y: 6280, width: 340, height: 550 },
  { label: 'Предложение месяца 2', target: 'product-page', x: 628, y: 6280, width: 328, height: 550 },
  { label: 'Предложение месяца 3', target: 'product-page', x: 986, y: 6280, width: 328, height: 550 },
  { label: 'Предложение месяца 4', target: 'product-page', x: 1340, y: 6280, width: 330, height: 550 },
  { label: 'Натуральные масла', target: 'shop-page', x: 0, y: 8020, width: 615, height: 470 },
  { label: 'Новинки', target: 'shop-page', x: 652, y: 8020, width: 615, height: 470 },
  { label: 'Полезная мука', target: 'shop-page', x: 1308, y: 8020, width: 612, height: 470 },
  { label: 'Больше новостей', target: 'blog-page', x: 1410, y: 9050, width: 252, height: 84 },
  { label: 'Читать новость о салате', target: 'blog-single-page', x: 350, y: 9600, width: 230, height: 82 },
  { label: 'Читать новость о витаминах', target: 'blog-single-page', x: 1070, y: 9600, width: 230, height: 82 },
  ...
  { label: '404 Not Found', target: 'not-found-page', x: 1320, y: 10510, width: 170, height: 42 },
