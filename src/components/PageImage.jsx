...
const HOTSPOTS = [
  ...
  { label: 'Тыквенное масло', target: 'shop-page', x: 260, y: 3180, width: 330, height: 640 },
  { label: 'Кунжутное масло', target: 'shop-page', x: 620, y: 3180, width: 330, height: 640 },
  { label: 'Масло грецкого ореха', target: 'shop-page', x: 980, y: 3180, width: 330, height: 640 },
  { label: 'Конопляное масло', target: 'shop-page', x: 1340, y: 3180, width: 330, height: 640 },
  ...
  { label: 'Предложение месяца 1', target: 'shop-page', x: 260, y: 6280, width: 340, height: 550 },
  { label: 'Предложение месяца 2', target: 'shop-page', x: 628, y: 6280, width: 328, height: 550 },
  { label: 'Предложение месяца 3', target: 'shop-page', x: 986, y: 6280, width: 328, height: 550 },
  { label: 'Предложение месяца 4', target: 'shop-page', x: 1340, y: 6280, width: 330, height: 550 },
