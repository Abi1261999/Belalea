...
const HOTSPOTS = [
  ...
  { label: 'Тыквенное масло', target: 'contacts', x: 260, y: 760, width: 330, height: 560 },
  { label: 'Кунжутное масло', target: 'contacts', x: 620, y: 760, width: 330, height: 560 },
  { label: 'Масло грецкого ореха', target: 'contacts', x: 980, y: 760, width: 330, height: 560 },
  { label: 'Конопляное масло', target: 'contacts', x: 1340, y: 760, width: 330, height: 560 },
  { label: 'Мука рисовая 1', target: 'contacts', x: 260, y: 1430, width: 330, height: 560 },
  { label: 'Мука рисовая 2', target: 'contacts', x: 620, y: 1430, width: 330, height: 560 },
  { label: 'Мука рисовая 3', target: 'contacts', x: 980, y: 1430, width: 330, height: 560 },
  { label: 'Мука рисовая 4', target: 'contacts', x: 1340, y: 1430, width: 330, height: 560 },
  { label: 'Масло тыквенное 2', target: 'contacts', x: 260, y: 2110, width: 330, height: 330 },
  { label: 'Масло кунжутное 2', target: 'contacts', x: 620, y: 2110, width: 330, height: 330 },
  { label: 'Масло грецкого ореха 2', target: 'contacts', x: 980, y: 2110, width: 330, height: 330 },
  { label: 'Масло конопляное 2', target: 'contacts', x: 1340, y: 2110, width: 330, height: 330 },
