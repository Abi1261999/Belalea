...
const HOTSPOTS = [
  ...
  { label: 'Новость о витамине D', target: 'blog-single-page', x: 258, y: 780, width: 684, height: 560 },
  { label: 'Новость о витаминах', target: 'blog-single-page', x: 976, y: 780, width: 686, height: 560 },
  { label: 'Новость о витамине C', target: 'blog-single-page', x: 258, y: 1460, width: 684, height: 560 },
  { label: 'Новость об органических продуктах', target: 'blog-single-page', x: 976, y: 1460, width: 686, height: 560 },
  { label: 'Новость о фруктах', target: 'blog-single-page', x: 258, y: 2140, width: 684, height: 560 },
  { label: 'Новость о пластике', target: 'blog-single-page', x: 976, y: 2140, width: 686, height: 560 },
